    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Experience seamless online learning with high-quality video conferencing, real-time collaboration, and integrated quiz systems
        </p>
        <Button 
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <Card className="glass-card p-12 max-w-4xl mx-auto">
          ...
          <Button 
            onClick={() => navigate("/class")}
            className="bg-primary hover:bg-primary/90 text-white px-6 py-5 text-lg"
          >
            Start Learning Now
          </Button>
        </Card>
